...
<nav>
    ...
    <ul>
        ...
        <li onclick="navigate(this)" data-page="writters" class="<?=(pageName=="admin-writters")?'active':'';?>"><a href="/admin/writters/1"><?=ResourceLoader::loadIcon('writters.svg')?>Writters</a></li>
